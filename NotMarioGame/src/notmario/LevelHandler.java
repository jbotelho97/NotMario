...
public class LevelHandler {
	...
	public void createLevel1() {
		...
		levelCollection[1][0] = new Rectangle(-25, -65, 100, 60, 51, 122, 0);
		levelCollection[1][1] = new Rectangle(75, -65, 25, 70, 51, 122, 0);
		levelCollection[1][2] = new Rectangle(125, -65, 40, 70, 51, 122, 0);
		levelCollection[1][3] = new Rectangle(165, -65, 30, 55, 51, 122, 0);
		levelCollection[1][4] = new Rectangle(195, -65, 10, 70, 51, 122, 0);
		levelCollection[1][5] = new Rectangle(205, -65, 10, 85, 51, 122, 0);
		levelCollection[1][6] = new Rectangle(235, -65, 50, 55, 51, 122, 0);
		levelCollection[1][7] = new Rectangle(300, -65, 15, 65, 51, 122, 0);
		levelCollection[1][8] = new Rectangle(315, -65, 15, 75, 51, 122, 0);
		levelCollection[1][9] = new Rectangle(330, -65, 20, 85, 51, 122, 0);
		levelCollection[1][10] = new Rectangle(350, -65, 125, 55, 51, 122, 0);
		levelCollection[1][11] = new Rectangle(475, -65, 50, 125, 51, 122, 0);
